...
use App\Http\Controllers\API\Emprendedores\Resenas\ResenasController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('emprendedores')->group(function () {
        ...
        Route::put('/{emprendedorId}/resenas/{resenaId}/estado', [ResenasController::class, 'updateEstado']);
        Route::delete('/{emprendedorId}/resenas/{resenaId}', [ResenasController::class, 'destroy']);
